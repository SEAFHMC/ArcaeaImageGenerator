...
from image_generator.AUA import UserRecent, AccountInfo, SongInfo, UserBest
...
def draw_single_song(data: Union[UserRecent, UserBest]):
    ...
    write_rating_up = DataText(210, 200, 15, "+12.60", StaticPath.exo_semibold, "ms")
...
res= draw_single_song(UserRecent(**data["content"]))
res.show()