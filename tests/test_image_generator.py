...
from image_generator.utils import open_img, DataText, draw_text, choice_ptt_background
from image_generator.assets import StaticPath
from PIL import Image
from image_generator.b30_image import draw_score_detail
...
res = draw_recent(arcaea_id="111111111", data=data)
res.show()